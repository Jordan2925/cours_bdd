...
- Comprendre la modélisation, la normalisation, et les types de tables (faits, dimensions, historique)
- Concevoir un schéma relationnel cohérent et performant

### Git et gestion de versions
- Initialiser un dépôt Git local et distant
- Suivre les bonnes pratiques de commit, branchement et fusion
- Collaborer via GitHub (issues, pull requests, README)

### Outils système et virtualisation
- Utiliser les commandes Unix essentielles
- Comprendre les différences entre VM, environnements virtuels et conteneurs
